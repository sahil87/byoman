...
- 2026-02-02: Convert ideas to a check list (keep the date also) - so we can keep marking things as done. Also add the command changes.idea that calls .specify/bin/idea
